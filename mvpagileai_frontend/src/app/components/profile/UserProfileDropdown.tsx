...
const UserProfileDropdown = () => {
    ...
    return (
        <div ref={wrapperRef} className="relative">
            ...
            {/* Dropdown Menu */}
            {isDropdownVisible && (
                <div className="absolute right-0 mt-2 py-2 px-2 min-w-max bg-white rounded-md shadow-xl z-20">
                    {/* User Info */}
                    <div className="block pl-2 pr-4 py-2 text-sm text-gray-700">
                        <div className="flex items-center">
                            ...
                            <div className="ml-3">
                                ...
                                <span className="text-gray-400 text-xs block">bryceneil123@gmail.com</span>
                            </div>
                        </div>
                    </div>
                    {/* Menu Items */}
