...
import { useTheme } from '@/app/components/theme/ThemeContext'; // Ensure this is the correct path
...
const LoginPage = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-100 dark:bg-darkgray p-6">
      {/* White container */}
      <div className="w-full max-w-sm bg-white dark:bg-medgray rounded-lg flex flex-col justify-between">
        <div>
          ...
          {/* Form content */}
          <h2 className="text-xl font-bold mb-2 text-gray-800 dark:text-gray-200 text-center">Welcome Back!</h2>
